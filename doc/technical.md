...
- 游戏：Monster Bash
- 类型：action
- 简述：AlterU arcade · voxel 弹珠台。左右半屏拍片，右侧发射道自动开球，3 球制。撞发光 pop bumper、弹弓与吸血鬼/狼人/僵尸/骷髅怪物靶得分，连击攒倍率。程序化音效 + 霓虹紫机台 + 比分排行榜，超过对手会推送通知。
- 框架 / 语言 / 构建：TypeScript, Vite, Three.js
- 渲染方式：Canvas/WebGL
- 依赖摘录：three@0.160.0, vite@^5.1.0
- 平台元信息：meta.title=Monster Bash；cover_url=/poster.png；category=action；uuid=68d88baf-726b-4f13-b133-637b2291d88b
